    ...
    <div class="content content-full-width">
        ...
        <div class="column two-third">
            ...
            <p>
				...
				$options['Abhyanga, Takradhaara, Steam bath (90min)'] = 'Abhyanga, Takradhaara, Steam bath (90min)';
				$options['Abhyanga, Pizhichil, Steam bath (90min)'] = 'Abhyanga, Pizhichil, Steam bath (90min)';
				$options['Abhyanga, Paada Abhyanga, Shiroabhyanga, Steam Bath (90min)'] = 'Abhyanga, Paada Abhyanga, Shiroabhyanga, Steam Bath (90min)';
				$options['Abhyanga, Thalapothichil, Steambath (100min)'] = 'Abhyanga, Thalapothichil, Steambath (100min)';
				$options['Abhyanga, Nasya, Steam Bath (100min)'] = 'Abhyanga, Nasya, Steam Bath (100min)';
				$options['Shirodhara, Facial (100min)'] = 'Shirodhara, Facial (100min)';
				$options['Abhyanga, Pizhichil, Shirodhara, Steam bath (120min)'] = 'Abhyanga, Pizhichil, Shirodhara, Steam bath (120min)';
				$options['Abhyanga, Potli, Shirodhara, Steam bath (120min)'] = 'Abhyanga, Potli, Shirodhara, Steam bath (120min)';
				$options['Abhyanga, Facial, Steam bath - (120min)'] = 'Abhyanga, Facial, Steam bath - (120min)';
				$options['Abhyanga, Pada Abhyanga, Shiroabhyanga, Shirodhara & Steam (120min)'] = 'Abhyanga, Pada Abhyanga, Shiroabhyanga, Shirodhara & Steam (120min)';
				$options['Abhyanga, Shirodhara, Facial, Steam bath (150min)'] = 'Abhyanga, Shirodhara, Facial, Steam bath (150min)';
                echo form_dropdown($data, $options, '');
                ?>                
            </p>
            <p>
        ...
        <div class="column one-third last">
            <div class="booknow-page">
				...
				<ul type="bullet" style="text-align: justify" class="flower-bullet green">
					<li><a href="<?php echo base_url().'assets_/dwlds/Single-day-Rejuvenation.pdf'?>">Single day rejuvenation programs</a></li>
					<li><a href="<?php echo base_url().'assets_/dwlds/Stressbustertherapies.pdf'?>">Stress buster therapies</a></li>
					<li><a href="<?php echo base_url().'assets_/dwlds/Weightlosstherapyplans.pdf'?>">Weight loss therapy plans</a></li>
					<li><a href="<?php echo base_url().'assets_/dwlds/6monthsMembershipPackage.pdf'?>">6 months membership plans</a></li>
					<li><a href="<?php echo base_url().'assets_/dwlds/Membership-Annual-Final.pdf'?>">One Year membership plans</a></li>
				</ul>
				
				<h4 class="title"> <span> Gift a Friend </span> </h4>
                <a href="<?php echo site_url('wellness/giftcard'); ?>" title=""> <img src="<?php echo base_url('assets_/images/post-images/gift-card.jpg');?>" alt="" title="" /> </a>
            </div>
        </div>
